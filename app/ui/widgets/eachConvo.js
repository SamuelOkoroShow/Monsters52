...
export default class ConvoTrans extends Component {
  ...
  render() {
    return (
      ...
      <ImageBackrground source={this.props.image} resizeMode="stretch" style={{flex:2, height:null, width:null, flexDirection:'row', alignItems:'flex-end', justifyContent:'flex-end'}}>
